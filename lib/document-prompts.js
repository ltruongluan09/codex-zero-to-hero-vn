...
- Bài học/sách/vở/ngoại ngữ: "điểm cần chú ý" không phải là rủi ro. Hãy chỉ ra ý chính, từ/cụm được tô sáng hoặc gạch chân nếu nhìn thấy, chỗ người học dễ hiểu sai, và câu hỏi nên tự kiểm tra lại.
- Nếu tài liệu không phải hợp đồng/báo giá/công việc, vẫn phải trả về red_flags theo nghĩa "điểm cần chú ý khi đọc" thay vì để trống.
...
Schema:
{
  ...
  "extracted_text": "toàn bộ văn bản đọc được từ tài liệu, giữ nguyên nội dung chính, không tự thêm nhận xét",
...
Quy tắc chất lượng:
- Với ảnh chụp hoặc PDF scan, ưu tiên OCR kỹ trước. Đừng chỉ đọc vài dòng đầu nếu ảnh còn nhiều chữ nhìn được.
- Nếu văn bản dài, extracted_text nên chứa càng nhiều nội dung đọc được càng tốt, đặc biệt phần đầu, giữa, cuối và các dòng được tô sáng/gạch/chú thích.
...
- extracted_text phải là phần chữ đọc được từ tài liệu. Nếu hệ thống đã cung cấp text trích xuất, có thể dùng lại phần đó. Nếu là ảnh/PDF, hãy OCR nội dung nhìn thấy tốt nhất có thể. Không đưa phân tích vào extracted_text.
