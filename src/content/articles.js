...
export const articles = [
  ...
  {
    slug: "claude-cho-ke-toan",
    type: "series",
    title: "Claude cho Kế toán Dịch vụ",
    desc: "Từ setup đến thực chiến — dành cho kế toán viên đang dùng Claude Pro.",
    href: "/bai-viet/claude-cho-ke-toan",
    tag: "Series",
    time: "4 bài",
    icon: "📒",
  ...
  {
    slug: "setup-claude-project-ke-toan",
    type: "article",
    title: "Cái đầu tiên mình làm khi mở Claude Pro",
    desc: "Setup Project trong 15 phút — để Claude nhớ công ty bạn, đúng TT20/2026, dùng được cả năm.",
    href: "/bai-viet/setup-claude-project-ke-toan",
    tag: "Claude",
    time: "4 phút đọc",
    icon: "📒",
    difficulty: "practical",
