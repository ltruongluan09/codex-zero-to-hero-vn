...
export const projectCatalog = [
  ...
  },
  {
    ...
    type: "tool",
    title: "SiteFlow Demo",
    desc: "Demo quản lý công trình: tiến độ, cảnh báo trễ hạn và nhật ký hiện trường.",
    outcome: "Giúp chủ đầu tư hoặc nhà thầu nhìn thấy một MVP SaaS có thể demo bán hàng nhanh.",
    status: "Demo mở sẵn",
    href: "/construction-demo",
    journeyHref: "/projects",
    icon: "🏗️",
    tag: "Construction SaaS",
    tool: "SiteFlow",
    audience: ["founder", "office", "nonTech"],
    useCases: ["Theo dõi công trình", "Ghi nhật ký hiện trường", "Demo bán hàng SaaS"],
    priority: 4,
    stage: "ready",
    featured: true,
