...
export default function ProjectDetailPage() {
  ...
  return (
    <div className="space-y-6">
      <Link to="/projects" className="inline-flex items-center gap-2 text-sm font-bold text-indigo-600">
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm md:p-6">
        <div className="flex flex-col justify-between gap-4 md:flex-row md:items-start">
          ...
          <Link to={`/logs/new?projectId=${project.id}`} className="inline-flex items-center justify-center gap-2 rounded-xl bg-indigo-600 px-5 py-3 text-sm font-bold text-white hover:bg-indigo-700">
        ...
        <section className="grid gap-6 xl:grid-cols-[1fr_1.4fr]">
          <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm md:p-6">
            ...
            <dl className="mt-5 space-y-4 text-sm">
              ...
              <Info label="Người phụ trách" value={project.manager} />
            </dl>
          </div>
          <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm md:p-6">
            ...
            <div className="mt-6">
              <div className="mb-3 flex items-end justify-between">
                <span className="text-5xl font-bold text-slate-900">{project.progress}%</span>
